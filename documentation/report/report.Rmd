---
title: "Evaluating Robustness of PRNU Signatures under Image Manipulations for Device Identification"
...
![PRNU processor iterator (\#fig:bb1)](../../diagrams/lucid_diagram01.png){width=100%}
\pagebreak
...
![The classes package (\#fig:bb2)](../../diagrams/packages_PRNU_Processor.png){width=80%}
\pagebreak
...
## 5.2. Computing Fingerprints and Noise Residuals:
...
## 5.4. Computing Cross-Correlation:
...
## 5.5. Computing Cross-Correlation Statistics:
Method: stats
...
## 5.6. Computing PCE (Phase-Only Correlation):
...
## 5.8. Final Metrics and Interpretation:
...
## Summary:
The testPRNU method is a comprehensive script for device identification using PRNU-based techniques. It loads image data, computes fingerprints and noise residuals, establishes ground truth, and evaluates system performance through cross-correlation and PCE. The printed AUC values offer a concise summary of the system's ability to distinguish between devices based on different correlation methods. The combination of cross-correlation and PCE, along with their respective statistics, provides a robust evaluation framework for the image forensics application.
